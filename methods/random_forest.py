...
class RandomForest:
    """
    A class for Random Forest, based on sklearn implementation.
    """
    def __init__(self, **kwargs):
        ...
        """
        self._model = RandomForestClassifier(**kwargs)  # Will never be trained, only used when plotting learning curves
        self._fitted_model = RandomForestClassifier(**kwargs)
    ...
    def plot_learning_curves(self, x_train, y_train, plotname):
        ...
        plot = utils.plot_learning_sklearn(self._model, 'Random Forest', x_train, y_train, cv=cv)
        plotpath = utils.save_training_plot(plot, f'rf_{plotname}')
        print(f'Random Forest -> Saved training plot in directory: "{plotpath}"')
    ...
    def save_model(self, filename):
        ...
        """
        utils.save_sklearn_model(filename, self._fitted_model, 'Random Forest')
